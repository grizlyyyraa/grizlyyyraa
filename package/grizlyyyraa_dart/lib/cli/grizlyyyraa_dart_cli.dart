...
import 'package:grizlyyyraa_dart/api/grizlyyyraa_dart_api_core.dart';
import 'package:universal_io/io.dart';

Logger logger = Logger();

Future<void> packageFullTemplateDartCli(List<String> args_raw) async {
  GrizlyyyraaDartApi packageFullTemplateDartApi = GrizlyyyraaDartApi();
  ...
  GrizlyyyraaDartBuildType server_universeDartBuildType = GrizlyyyraaDartBuildType.release;

  if (args.contains("--debug")) {
    server_universeDartBuildType = GrizlyyyraaDartBuildType.debug;
  }
